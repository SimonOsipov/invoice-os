...
// The worker's marker-only set: AI failed, so nothing else was read. Not wired yet (scaffold).
export function isAIUnavailable(_fields: readonly ExtractionFieldState[]): boolean {
  return false
}
