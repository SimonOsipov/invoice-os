...
export const SURFACES: readonly SurfaceDef[] = [
  ...
  { navConst: 'NAV_AUDIT', label: 'Audit' },
...
export const PERSONAS: Record<PersonaId, PersonaDef> = {
  ...
  inhouse: {
    ...
    // a frontend fixture, and neither policy internal/demopolicy seeds onto this IN-HOUSE
    // tenant (the active one plus the draft) matches those strings. The grade stays `drives` on
