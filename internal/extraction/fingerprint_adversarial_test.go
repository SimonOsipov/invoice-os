...
const emptyFingerprint = "v3:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
...
func TestAnchorObservations_NoMatchIsEmptyNotNil(t *testing.T) {
	...
	if fp := extraction.Fingerprint(page); fp != emptyFingerprint {
		t.Errorf("Fingerprint(page with no recognised label) = %q, want %q -- a real v3: value, not a degenerate one", fp, emptyFingerprint)
	}
}
...
const bxEmptyFingerprint = "b3:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
...
func TestBoxlessFingerprint_EmptyInputStillFingerprints(t *testing.T) {
	...
	if strings.TrimPrefix(bxEmptyFingerprint, "b3:") != strings.TrimPrefix(emptyFingerprint, "v3:") {
