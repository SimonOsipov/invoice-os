...
-- one (role, status, display_name) is reverted on the next deploy.
...
--
-- BUG-06-07 (task-389): failure_kind stamps WHY each `failed` row is a dead end
-- (migrations/20260805075045_invoices_failure_kind.sql). 1004/2002/2003 keep
-- 'acknowledged_no_verdict' under the shared Kano Agro counterparty -- same scenario, same
-- buyer, per TestSeedOneScenarioPerCounterparty. 2004 (payload_not_built) and 5004 (NULL,
-- the legacy/AC-7 degrade case) get their OWN counterparty each: payload_not_built and NULL
-- are otherwise-identical `failed` rows to the scenario-key test (no violations, validated,
-- clean supplier TIN), so sharing Kano's TIN would collide two distinct scenarios onto one
-- buyer -- a label edit alone would also fail TestSeedOneBuyerNamePerBuyerTIN.
WITH invoice_seed (
    tin, invoice_number, status, issue_date, supplier_tin, supplier_name,
    buyer_tin, buyer_name, subtotal, vat, total, validated, violations, rejection_reasons, failure_kind
) AS (
  VALUES
    ...
    -- accepted.
    ('10012345-0001', 'DEMO-2026-1001', 'accepted',  '2026-01-05', '10012345-0001', 'Adeyemi & Sons Trading Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 500000.00, 37500.00, 537500.00, true,  '[]', '[]', NULL),
    ('10012345-0001', 'DEMO-2026-1002', 'accepted',  '2026-01-11', '10012345-0001', 'Adeyemi & Sons Trading Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 220000.00, 16500.00, 236500.00, true,  '[]', '[]', NULL),
    ('10012345-0001', 'DEMO-2026-1003', 'validated', '2026-01-17', '10012345-0001', 'Adeyemi & Sons Trading Ltd', '20022233-0002', 'Lagos Textiles Mart (validated, ready to submit)',            180000.00, 13500.00, 193500.00, true,  '[]', '[]', NULL),
    ('10012345-0001', 'DEMO-2026-1004', 'failed',    '2026-01-23', '10012345-0001', 'Adeyemi & Sons Trading Ltd', '20033344-0003', 'Kano Agro Distributors (sent, no verdict)',                   95000.00,  7125.00,  102125.00, true,  '[]', '[]', 'acknowledged_no_verdict'),
    ...
    ('10012345-0001', 'DEMO-2026-1009', 'validated', '2026-06-28', '10012345-0001', 'Adeyemi & Sons Trading Ltd', '99999999-0003', 'Sandbox APP (defers, then accepts)',     144000.00, 10800.00, 154800.00, true,  '[]', '[]', NULL),

    -- Chukwu Global Ventures Ltd (10023456-0002) -- the late-lifecycle failures, plus one
    -- blocked draft.
    ('10023456-0002', 'DEMO-2026-2001', 'accepted',  '2026-02-10', '10023456-0002', 'Chukwu Global Ventures Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)',    310000.00, 23250.00, 333250.00, true, '[]', '[]', NULL),
    ('10023456-0002', 'DEMO-2026-2002', 'failed',    '2026-02-16', '10023456-0002', 'Chukwu Global Ventures Ltd', '20033344-0003', 'Kano Agro Distributors (sent, no verdict)',                     128000.00, 9600.00,  137600.00, true, '[]', '[]', 'acknowledged_no_verdict'),
    ('10023456-0002', 'DEMO-2026-2003', 'failed',    '2026-02-22', '10023456-0002', 'Chukwu Global Ventures Ltd', '20033344-0003', 'Kano Agro Distributors (sent, no verdict)',                     84000.00,  6300.00,  90300.00,  true, '[]', '[]', 'acknowledged_no_verdict'),
    ('10023456-0002', 'DEMO-2026-2004', 'failed',    '2026-02-28', '10023456-0002', 'Chukwu Global Ventures Ltd', '20099900-0009', 'Owerri Consumer Traders (never left our system)',               45000.00,  3375.00,  48375.00,  true, '[]', '[]', 'payload_not_built'),
    ...
    ('10034567-0003', 'DEMO-2026-3001', 'accepted',  '2026-03-12', '10034567-0003', 'Okonkwo Textiles Nigeria Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 265000.00, 19875.00, 284875.00, true,  '[]', '[]', NULL),
    ('10034567-0003', 'DEMO-2026-3002', 'accepted',  '2026-03-18', '10034567-0003', 'Okonkwo Textiles Nigeria Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 142000.00, 10650.00, 152650.00, true,  '[]', '[]', NULL),
    ('10034567-0003', 'DEMO-2026-3003', 'rejected',  '2026-03-24', '10034567-0003', 'Okonkwo Textiles Nigeria Ltd', '20077788-0007', 'Enugu Metal Works Ltd (rejected by the authority)',          88000.00,  6600.00,  94600.00,  true,
      '[]', '[{"code":"NGE-4102","message":"Customer tax identifier is not registered with the tax authority.","path":"buyer.tin"}]', NULL),
    ('10034567-0003', 'DEMO-2026-3004', 'validated', '2026-03-30', '10034567-0003', 'Okonkwo Textiles Nigeria Ltd', '20022233-0002', 'Lagos Textiles Mart (validated, ready to submit)',           51000.00,  3825.00,  54825.00,  true,  '[]', '[]', NULL),
    ('10034567-0003', 'DEMO-2026-3005', 'draft',     '2026-04-05', '10034567-0003', 'Okonkwo Textiles Nigeria Ltd', '20044455-0004', 'Ibadan Consumer Goods Ltd (draft, not yet validated)',       39000.00,  2925.00,  41925.00,  false, '[]', '[]', NULL),

    -- Balogun Agro-Allied Ltd (10045678-0004) -- one line-items/subtotal mismatch.
    ('10045678-0004', 'DEMO-2026-4001', 'accepted',  '2026-04-11', '10045678-0004', 'Balogun Agro-Allied Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 198000.00, 14850.00, 212850.00, true,  '[]', '[]', NULL),
    ('10045678-0004', 'DEMO-2026-4002', 'draft',     '2026-04-17', '10045678-0004', 'Balogun Agro-Allied Ltd', '20066677-0006', 'Abuja Office Interiors Ltd (lines do not sum to subtotal)', 100000.00, 7500.00,  107500.00, true,
      '[{"rule_key":"line-items-sum-subtotal","severity":"error","message":"Line item amounts must sum to the invoice subtotal."}]', '[]', NULL),
    ('10045678-0004', 'DEMO-2026-4003', 'validated', '2026-04-23', '10045678-0004', 'Balogun Agro-Allied Ltd', '20022233-0002', 'Lagos Textiles Mart (validated, ready to submit)',          62000.00,  4650.00,  66650.00,  true,  '[]', '[]', NULL),
    ('10045678-0004', 'DEMO-2026-4004', 'draft',     '2026-04-29', '10045678-0004', 'Balogun Agro-Allied Ltd', '20044455-0004', 'Ibadan Consumer Goods Ltd (draft, not yet validated)',      40000.00,  3000.00,  43000.00,  false, '[]', '[]', NULL),
    ...
    ('10056789-0005', 'DEMO-2026-5001', 'accepted',  '2026-05-05', '10056789-0005', 'Emeka Pharmaceuticals Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 145000.00, 10875.00, 155875.00, true, '[]', '[]', NULL),
    ('10056789-0005', 'DEMO-2026-5002', 'accepted',  '2026-05-11', '10056789-0005', 'Emeka Pharmaceuticals Ltd', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)', 210000.00, 15750.00, 225750.00, true, '[]', '[]', NULL),
    ('10056789-0005', 'DEMO-2026-5003', 'validated', '2026-05-17', '10056789-0005', 'Emeka Pharmaceuticals Ltd', '20022233-0002', 'Lagos Textiles Mart (validated, ready to submit)',          76000.00,  5700.00,  81700.00,  true, '[]', '[]', NULL),
    ('10056789-0005', 'DEMO-2026-5004', 'failed',    '2026-05-23', '10056789-0005', 'Emeka Pharmaceuticals Ltd', '20088800-0010', 'Nsukka Farm Supplies (failed before reasons were recorded)', 33000.00,  2475.00,  35475.00,  true, '[]', '[]', NULL),
    ('10056789-0005', 'DEMO-2026-5005', 'draft',     '2026-05-29', '10056789-0005', 'Emeka Pharmaceuticals Ltd', '20044455-0004', 'Ibadan Consumer Goods Ltd (draft, not yet validated)',      48000.00,  3600.00,  51600.00,  false, '[]', '[]', NULL),
    ...
    ('10067890-0006', 'DEMO-2026-6002', 'draft', '2026-06-10', 'BADTIN', 'Aliyu Logistics Services Ltd', '20088899-0008', 'Jos Highland Farms Ltd (supplier TIN malformed)', 54000.00, 4050.00, 58050.00, true,
      '[{"rule_key":"supplier-tin-format","severity":"error","message":"Supplier TIN must be in the format NNNNNNNN-NNNN (8 digits, hyphen, 4 digits).","path":"supplier.tin"}]', '[]', NULL),
    ('10067890-0006', 'DEMO-2026-6003', 'draft', '2026-06-16', '10067890-0006', 'Aliyu Logistics Services Ltd', '12345678', 'Calabar Marine Services Ltd (buyer TIN malformed)', 47000.00, 3525.00, 50525.00, true,
      '[{"rule_key":"buyer-tin-format","severity":"error","message":"Buyer TIN, when present, must be in the format NNNNNNNN-NNNN.","path":"buyer.tin"}]', '[]', NULL)
)
INSERT INTO invoices (
    ...
    failure_kind, irn, csid, qr_payload, created_at
)
SELECT
    ...
    CASE WHEN s.validated THEN rsv.id ELSE NULL END, s.rejection_reasons::jsonb, s.failure_kind,
...
WITH inhouse_invoice_seed (
  ...
  VALUES
    ('DEMO-2026-7001', 'accepted',  '2026-01-08', '99999999-0001', 'Sandbox APP (always accepts)',                400000.00, 30000.00, 430000.00, true, '[]', '[]', NULL),
    ('DEMO-2026-7002', 'rejected',  '2026-01-22', '99999999-0002', 'Sandbox APP (always rejects)',                180000.00, 13500.00, 193500.00, true,
      '[]', '[{"code":"NGE-4102","message":"Customer tax identifier is not registered with the tax authority.","path":"buyer.tin"}]', NULL),
    ('DEMO-2026-7003', 'accepted',  '2026-02-05', '99999999-0003', 'Sandbox APP (defers, then accepts)',          260000.00, 19500.00, 279500.00, true, '[]', '[]', NULL),
    ('DEMO-2026-7004', 'failed',    '2026-02-19', '99999999-0004', 'Sandbox APP (unavailable, never verdicts)',   145000.00, 10875.00, 155875.00, true, '[]', '[]', 'never_acknowledged'),
    ('DEMO-2026-7006', 'failed',    '2026-03-05', '99999999-0006', 'Sandbox APP (times out, never verdicts)',      92000.00,  6900.00,  98900.00, true, '[]', '[]', 'never_acknowledged'),

    ('DEMO-2026-8001', 'accepted',  '2026-03-19', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)',    320000.00, 24000.00, 344000.00, true, '[]', '[]', NULL),
    ('DEMO-2026-8002', 'accepted',  '2026-04-02', '20011122-0001', 'Zenith Freight & Logistics Ltd (accepted by the authority)',    215000.00, 16125.00, 231125.00, true, '[]', '[]', NULL),
    ('DEMO-2026-8003', 'validated', '2026-04-16', '20022233-0002', 'Lagos Textiles Mart (validated, ready to submit)',               88000.00,  6600.00,  94600.00, true, '[]', '[]', NULL),
    ('DEMO-2026-8004', 'draft',     '2026-05-01', '20044455-0004', 'Ibadan Consumer Goods Ltd (draft, not yet validated)',           64000.00,  4800.00,  68800.00, false, '[]', '[]', NULL),
    ...
    ('DEMO-2026-9001', 'validated', '2026-06-10', '99999999-0001', 'Sandbox APP (always accepts)',       240000.00, 18000.00, 258000.00, true, '[]', '[]', NULL),
    ('DEMO-2026-9002', 'validated', '2026-06-18', '99999999-0002', 'Sandbox APP (always rejects)',       168000.00, 12600.00, 180600.00, true, '[]', '[]', NULL),
    ('DEMO-2026-9003', 'validated', '2026-06-26', '99999999-0003', 'Sandbox APP (defers, then accepts)', 196000.00, 14700.00, 210700.00, true, '[]', '[]', NULL)
)
INSERT INTO invoices (
    tenant_id, entity_id, invoice_number, status, issue_date, supplier_tin, supplier_name,
    buyer_tin, buyer_name, currency, subtotal, vat, total, violations, rule_set_version_id, rejection_reasons,
