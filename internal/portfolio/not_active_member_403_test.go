// AUDIT-10-03 site 7 of 14: portfolio's statusForErr must map the seam's
...
func TestPortfolioStatusForErr_NotActiveMemberIs403(t *testing.T) {
	for _, tc := range []struct {
		name string
		err  error
	}{
		{"bare", db.ErrNotActiveMember},
		{"wrapped", fmt.Errorf("portfolio: list: %w", db.ErrNotActiveMember)},
	} {
