...
export function ScanlineSteps({
  ...
  return (
    <div style={{ background: 'var(--bg-2)', border: '1px solid var(--line-1)', borderRadius: 'var(--radius-md)', padding: '44px 20px 52px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
