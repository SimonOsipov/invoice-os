...
// infoGlyph's circle with the stem above the dot, for a reason/warning tooltip trigger.
export const alertCircleGlyph = <Icon paths={['M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z', 'M12 8v5', 'M12 16h.01']} size={14} />
