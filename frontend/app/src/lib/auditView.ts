...
export const AUDIT_COPY = {
  ...
  searchHelper:
    'Searches event details, invoice numbers, rule keys, IRNs, company names and member display names. An invoice number matches that invoice\'s events, including older ones that do not list the number in their own details. It cannot find a member shown by their email address.',
