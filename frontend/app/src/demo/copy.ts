...
// The floor App holds the busy beat open for, regardless of round-trip speed.
...
// The design draws no dismiss control at all; this button and its aria-label are ours.
