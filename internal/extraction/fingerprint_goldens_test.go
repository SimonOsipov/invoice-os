...
// fgGoldenFloor is the arithmetic AC-6 states: 27 committed PDFs today plus the 2 new Chrome
// ones. A floor to assert, not a comment -- a table silently truncated to zero would satisfy
// every loop below.
const fgGoldenFloor = 29
