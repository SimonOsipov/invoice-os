...
func importGreenFixture(t *testing.T, path, tenantLabel, entityName string) BatchResult {
	t.Helper()
...
func TestFixtures_Green500ImportsAndValidatesClean(t *testing.T) {
	res := importGreenFixture(t, "../../testdata/invoices/green_500.csv",
...
func TestFixtures_GreenSecondImportsAndValidatesClean(t *testing.T) {
	res := importGreenFixture(t, "../../testdata/invoices/green_second.csv",
...
// violationKeys(res) (the 04 rule-engine path) -- assertCleanImport already
// pins len(InvoiceViolations)==0 for the whole file, this test specifically
// names the rule this AC is about.
